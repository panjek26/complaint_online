            ...
            <div class="container-fluid">
                <div class="row">				
                    <div class="panel panel-default">
                        <h3 class="page-header">Data Toko</h3>
						
                        <div class="panel-body">
                            <!-- Nav tabs -->
						<div class="col-xs-2">
                            <a href="department_add.php" class="btn btn-primary btn-block">Add Toko</a>
						</div>
                            ...
                            <div class="tab-content">
								...
								<div class="col-xs-5">
								  ...
								  <thead>
									...
									<tbody>
<?php 
	$check=$fungsi->get_department(1);
	if(mysql_num_rows($check)==0){
?>
										<tr>
										<td colspan="3">Data No Match In Database</td>
										</tr>
<?php } else {  $index=1;
...
?>
										<tr>
											...
											<form action="department_edit.php" method="POST"><input type="hidden" name="id" value="<?php echo $row['id_dept'] ?>"/>
